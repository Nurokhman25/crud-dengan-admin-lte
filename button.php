        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					<h5><center>Apakah Anda Ingin Menghapus Nama Ini: <strong><?php echo $drow['nama']; ?></strong></center></h5> 
                </div> 
				</div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                    <a href="hapus.php?id=<?php echo $row['userid']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                </div>
            ...
            <div class="modal-content">
				...
				<form method="POST" action="edit.php?id=<?php echo $erow['userid']; ?>">
					<div class="row">
						...
						<div class="col-lg-8">
							<input type="text" size="45" name="nama" class="form-control" value="<?php echo $erow['nama']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
					<div class="row">
						<div class="col-lg-4">
							<label style="position:relative; top:7px;">Tanggal Lahir:</label>
						</div>
						<div class="col-lg-8">
							<input type="text" size="45" name="tanggal_lahir" class="form-control" value="<?php echo $erow['tanggal_lahir']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
					<div class="row">
						...
						<div class="col-lg-8">
							<input type="text" size="45" name="alamat" class="form-control" value="<?php echo $erow['alamat']; ?>">
						</div>
					</div>
                </div> 
				</div>
